...
function setIndex(){
	...
	indexStr += '		<p>인터렉티브</p>';
	indexStr += '		<ul> ';
	indexStr += '			<li id="sub01"><span>쓰레기 비우기</span></li> ';
	indexStr += '			<li id="sub02"><span>단어완성 (클릭형)</span></li> ';
	indexStr += '			<li id="sub03"><span>빈칸 채우기</span></li> ';	
	indexStr += '			<li id="sub04"><span>상자에 받기</span></li> ';	
	indexStr += '		</ul> ';
	indexStr += ' </div> ';
